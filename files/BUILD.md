...
Right-click the icon for the menu. Type Clipboard does the same as a left click, Type File… types a text file instead, the Speed submenu sets words per minute from 30 to 70, and the Mistakes submenu sets what share of characters get a wrong key first, from none up to 30%.
